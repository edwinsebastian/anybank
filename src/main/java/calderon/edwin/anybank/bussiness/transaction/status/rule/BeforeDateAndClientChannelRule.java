...
@Component
public class BeforeDateAndClientChannelRule implements ITransactionStatusRule {
    @Override
    public String getType() {
        return "beforeDateAndCLIENTChannelRule";
    }

    @Override
    public TransactionStatusResDto checkTransactionStatus(TransactionModel transactionModel) {
        return getPartialTransactionResDto(transactionModel, TransactionStatusEnum.SETTLED);
    }
}
