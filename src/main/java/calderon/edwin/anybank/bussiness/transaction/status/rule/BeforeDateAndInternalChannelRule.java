...
@Component
public class BeforeDateAndInternalChannelRule implements ITransactionStatusRule {
    @Override
    public String getType() {
        return "beforeDateAndINTERNALChannelRule";
    }

    @Override
    public TransactionStatusResDto checkTransactionStatus(TransactionModel transactionModel) {
        return getFullTransactionResDto(transactionModel, TransactionStatusEnum.SETTLED);
    }
}
