...
@Component
public class FutureDateAndInternalChannelRule implements ITransactionStatusRule {
    @Override
    public String getType() {
        return "futureDateAndINTERNALChannelRule";
    }

    @Override
    public TransactionStatusResDto checkTransactionStatus(TransactionModel transactionModel) {
        return getFullTransactionResDto(transactionModel, TransactionStatusEnum.FUTURE);
    }
}
